...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-[#f6f4f0]">
      {/* Nav */}
      <nav className="flex justify-between items-center px-6 py-4 max-w-[960px] mx-auto border-b border-[#e5e0d8]">
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-display text-[22px] font-extrabold tracking-tight text-[#1a1a1a]">
            alkansya<span className="text-[#c8940a]">.ph</span>
          </span>
        </div>
        <div className="flex items-center gap-4">
          <span className="font-mono text-[10px] uppercase tracking-[2px] text-[#6b6560] hidden sm:inline">
            Updated weekly
          </span>
      ...
      <main className="max-w-[960px] mx-auto px-6 py-8">
        ...
        <div className="mb-12 animate-slide-up">
          <p className="font-mono text-[11px] uppercase tracking-[3px] text-[#c8940a] mb-2">
            Compare PH Bank Rates
          </p>
          <h1 className="font-display text-4xl md:text-5xl font-black leading-[1.05] mb-3 tracking-tight text-[#1a1a1a]">
            Saan mo ilalagay
            <br />
            ang <span className="text-[#c8940a]">pera</span> mo?
          </h1>
          <p className="font-display text-base md:text-lg text-[#6b6560] max-w-[520px] leading-relaxed mb-8">
        ...
        {/* Stats strip */}
        <div className="grid grid-cols-3 gap-px bg-[#e5e0d8] rounded-2xl overflow-hidden mb-10 shadow-sm">
          {[
            ...
            <div key={i} className="bg-white py-5 px-6 text-center">
              <p className="font-mono text-[9px] uppercase tracking-[2px] text-[#9a9490] mb-1.5">
                {stat.label}
              </p>
              <p className={`font-display text-2xl md:text-3xl font-extrabold ${stat.color}`}>
                {stat.value}
              </p>
            </div>
          ))}
        ...
        {/* PDIC notice */}
        <div className="mt-6 p-4 md:p-5 rounded-xl bg-white border border-[#e5e0d8] flex gap-3 shadow-sm">
          <span className="text-lg">🛡️</span>
          <div>
            <p className="font-display text-[13px] font-semibold text-[#1a1a1a] mb-1">
        ...
        {/* Footer */}
        <footer className="mt-12 pt-6 border-t border-[#e5e0d8] flex justify-between items-center flex-wrap gap-3">
          <div>
            <p className="font-display text-sm font-bold text-[#6b6560]">
              alkansya<span className="text-[#c8940a]">.ph</span>
            </p>
            <p className="font-mono text-[10px] text-[#9a9490] mt-1">
              Making smarter savings accessible to every Filipino.
            </p>
          </div>
          <p className="font-mono text-[9px] text-[#b0aaa4]">
