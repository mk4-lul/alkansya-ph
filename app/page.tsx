...
const FALLBACK_BANKS: BankWithRates[] = [
  ...
  { id: "pnb", name: "PNB", type: "traditional", logo: "🏛️", source_url: "https://www.pnb.com.ph", notes: "Top Saver account", has_promo: false, promo_rate: null, promo_terms: null, savings_rate: 0.5, savings_min_rate: 0.1, savings_tiers: [{ rate: 0.1, min_deposit: 0, max_deposit: 49999 }, { rate: 0.5, min_deposit: 50000, max_deposit: null }], time_deposit_rates: [{ term_days: 30, rate: 0.5 }, { term_days: 90, rate: 0.75 }, { term_days: 180, rate: 1.0 }, { term_days: 360, rate: 1.25 }], last_verified: "2026-03-08T00:00:00Z" },
...
export default async function HomePage() {
  ...
  return (
    <div className="min-h-screen">
      {/* Nav */}
      <nav className="flex justify-between items-center px-6 py-4 max-w-[960px] mx-auto border-b border-alkansya-border">
        <div className="flex items-center gap-2.5">
          <div
            className="w-8 h-8 rounded-lg flex items-center justify-center text-base font-bold text-white"
            style={{ background: "linear-gradient(135deg, #c8940a, #a87a08)" }}
          >
            ₱
          </div>
          <span className="font-display text-[22px] font-extrabold tracking-tight text-alkansya-text">
            alkansya<span className="text-alkansya-gold">.ph</span>
          </span>
        </div>
        <div className="flex items-center gap-4">
          <span className="font-mono text-[10px] uppercase tracking-[2px] text-alkansya-muted hidden sm:inline">
            Updated weekly
          </span>
      ...
      <main className="max-w-[960px] mx-auto px-6 py-8">
        ...
        <div className="mb-12 animate-slide-up">
          ...
          <h1 className="font-display text-4xl md:text-5xl font-black leading-[1.05] mb-3 tracking-tight text-alkansya-text">
            Saan mo ilalagay
            <br />
            ang <span className="text-alkansya-gold">pera</span> mo?
          </h1>
          <p className="font-display text-base md:text-lg text-alkansya-muted max-w-[520px] leading-relaxed mb-8">
        ...
        {/* Stats strip */}
        <div className="grid grid-cols-3 gap-px bg-alkansya-border rounded-2xl overflow-hidden mb-10 shadow-sm">
          {[
            {
              label: "Avg. Traditional",
              value: `${avgTraditional.toFixed(3)}%`,
              color: "text-alkansya-muted",
            },
            {
              label: "Avg. Digital",
            ...
            <div key={i} className="bg-white py-5 px-6 text-center">
              <p className="font-mono text-[9px] uppercase tracking-[2px] text-alkansya-muted/60 mb-1.5">
                {stat.label}
              </p>
              <p
        ...
        {/* PDIC notice */}
        <div className="mt-6 p-4 md:p-5 rounded-xl bg-white border border-alkansya-border flex gap-3 shadow-sm">
          <span className="text-lg">🛡️</span>
          <div>
            <p className="font-display text-[13px] font-semibold text-alkansya-text/80 mb-1">
              PDIC Insured up to ₱500,000
            </p>
            <p className="font-mono text-[11px] text-alkansya-muted leading-relaxed">
        ...
        {/* Footer */}
        <footer className="mt-12 pt-6 border-t border-alkansya-border flex justify-between items-center flex-wrap gap-3">
          <div>
            <p className="font-display text-sm font-bold text-alkansya-muted">
              alkansya<span className="text-alkansya-gold">.ph</span>
            </p>
            <p className="font-mono text-[10px] text-alkansya-muted/50 mt-1">
              Making smarter savings accessible to every Filipino.
            </p>
          </div>
          <p className="font-mono text-[9px] text-alkansya-muted/40">
