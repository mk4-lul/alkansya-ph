...
function AnimatedNumber({ value, prefix = "", suffix = "" }: { value: number; prefix?: string; suffix?: string }) {
  ...
  return (
    <span>
      {prefix}
      {display.toLocaleString("en-PH", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
      {suffix}
    </span>
  );
}
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl p-8 md:p-10"
      ...
      <div className="relative z-10">
        ...
        <div className="rounded-2xl p-6 border" style={{ background: "rgba(0,0,0,0.2)", borderColor: "rgba(255,195,0,0.15)" }}>
