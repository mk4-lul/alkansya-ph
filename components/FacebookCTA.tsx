...
const STORAGE_KEY = "sentral_fb_dismissed";
    ...
    <div className="relative animate-[fadeSlideUp_0.4s_ease-out]">
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          <p className="text-sm font-bold text-[#1a1a1a]">Follow Sentral on Facebook</p>
          <p className="text-[11px] text-[#888]">Money tips and market updates</p>
        </div>
